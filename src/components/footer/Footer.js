            ...
            <div className="footer__infor">
              ...
              <div className="footer__infor-list">
                ...
                <Link
                  ...
                  className="footer__infor-item"
                >
                  <img src={emailImg} alt="" />
                  <p>Địa chỉ email: email@gmail.com</p>
                </Link>
              </div>
            </div>
